    ...
    public partial class Usr : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StoreNotificationId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Status = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreNotification", x => x.StoreNotificationId);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 7, 26, 11, 25, 51, 580, DateTimeKind.Local).AddTicks(5719), "fas fa-home", true, true, 0, null, null, "Dashboard", 0, 1, "/DashBoard/Index" },
                    { 10, 1, new DateTime(2023, 7, 26, 11, 25, 51, 580, DateTimeKind.Local).AddTicks(7457), "", true, true, 0, null, null, "Change Password", 9, 0, "/User/ChangePassword" },
                    { 8, 1, new DateTime(2023, 7, 26, 11, 25, 51, 580, DateTimeKind.Local).AddTicks(7448), "", true, true, 0, null, null, "Profile", 5, 0, "/User/UserProfile" },
                    { 7, 1, new DateTime(2023, 7, 26, 11, 25, 51, 580, DateTimeKind.Local).AddTicks(7444), "", true, true, 0, null, null, "Role List", 5, 0, "/User/RoleList" },
                    { 6, 1, new DateTime(2023, 7, 26, 11, 25, 51, 580, DateTimeKind.Local).AddTicks(7440), "", true, true, 0, null, null, "User List", 5, 0, "/User/UserList" },
                    { 9, 1, new DateTime(2023, 7, 26, 11, 25, 51, 580, DateTimeKind.Local).AddTicks(7452), "fas fa-wrench", true, true, 1, null, null, "Settings", 0, 4, "" },
                    { 4, 1, new DateTime(2023, 7, 26, 11, 25, 51, 580, DateTimeKind.Local).AddTicks(7431), "", true, true, 0, null, null, "Menu Group List", 2, 0, "/Menu/MenuGroupList" },
                    { 3, 1, new DateTime(2023, 7, 26, 11, 25, 51, 580, DateTimeKind.Local).AddTicks(7427), "", true, true, 0, null, null, "Menu List", 2, 0, "/Menu/MenuList" },
                    { 2, 1, new DateTime(2023, 7, 26, 11, 25, 51, 580, DateTimeKind.Local).AddTicks(7413), "fas fa-ellipsis-v", true, true, 1, null, null, "Menu", 0, 2, "" },
                    { 5, 1, new DateTime(2023, 7, 26, 11, 25, 51, 580, DateTimeKind.Local).AddTicks(7436), "fas fa-user", true, true, 1, null, null, "User", 0, 3, "" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 7, 26, 11, 25, 51, 569, DateTimeKind.Local).AddTicks(6215), true, true, null, null, "Super Admin Group" },
                    { 2, 1, new DateTime(2023, 7, 26, 11, 25, 51, 571, DateTimeKind.Local).AddTicks(3747), true, true, null, null, "User Group" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7, 1, new DateTime(2023, 7, 26, 11, 25, 51, 583, DateTimeKind.Local).AddTicks(867), true, true, 1, 10 },
                    { 10, 1, new DateTime(2023, 7, 26, 11, 25, 51, 583, DateTimeKind.Local).AddTicks(877), true, true, 2, 10 },
                    { 9, 1, new DateTime(2023, 7, 26, 11, 25, 51, 583, DateTimeKind.Local).AddTicks(874), true, true, 2, 8 },
                    { 8, 1, new DateTime(2023, 7, 26, 11, 25, 51, 583, DateTimeKind.Local).AddTicks(871), true, true, 2, 1 },
                    { 6, 1, new DateTime(2023, 7, 26, 11, 25, 51, 583, DateTimeKind.Local).AddTicks(864), true, true, 1, 8 },
                    { 1, 1, new DateTime(2023, 7, 26, 11, 25, 51, 582, DateTimeKind.Local).AddTicks(9113), true, true, 1, 1 },
                    { 4, 1, new DateTime(2023, 7, 26, 11, 25, 51, 583, DateTimeKind.Local).AddTicks(857), true, true, 1, 6 },
                    { 3, 1, new DateTime(2023, 7, 26, 11, 25, 51, 583, DateTimeKind.Local).AddTicks(853), true, true, 1, 4 },
                    { 2, 1, new DateTime(2023, 7, 26, 11, 25, 51, 583, DateTimeKind.Local).AddTicks(840), true, true, 1, 3 },
                    { 5, 1, new DateTime(2023, 7, 26, 11, 25, 51, 583, DateTimeKind.Local).AddTicks(860), true, true, 1, 7 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 7, 26, 11, 25, 51, 575, DateTimeKind.Local).AddTicks(4303), true, true, null, null, 1, null, "Admin" },
                    { 2, 1, new DateTime(2023, 7, 26, 11, 25, 51, 575, DateTimeKind.Local).AddTicks(6376), true, true, null, null, 2, null, "User" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 7, 26, 11, 25, 51, 577, DateTimeKind.Local).AddTicks(4958), null, null, "Appman", null, true, true, false, null, null, null, null, "Appman@2019", null, "developer", 1 },
                    { 2, 1, new DateTime(2023, 7, 26, 11, 25, 51, 577, DateTimeKind.Local).AddTicks(7337), null, null, "Helen Smith", null, true, true, false, null, null, null, null, "user@2020", null, "user@2020", 2 }
                });
        }
