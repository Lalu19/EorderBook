#pragma checksum "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c3f741616c2d0f59c8d4ff1baff52482c2d3ee9a"
// <auto-generated/>
...
#nullable restore
#line 1 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
...
#nullable disable
#nullable restore
#line 2 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
using Microsoft.AspNetCore.Http;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c3f741616c2d0f59c8d4ff1baff52482c2d3ee9a", @"/Views/User/UserList.cshtml")]
    #nullable restore
    ...
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 5 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
        ...
        <div class=""modal-content"">
            ...
            WriteLiteral(@"ss=""col-lg-6"">
                                    <div class=""form-group"">
                                        <label class=""control-label"">Company Name&nbsp;<span style=""color: red;""><b>*</b></span></label>
                                        <input type=""text"" class=""form-control"" id=""name"" autocomplete=""off"" placeholder=""Company Name"" required />
                                    </div>
                                </div>
                                <div class=""col-lg-6"">
                                    <div class=""form-group"">
                                        <label class=""control-label"">Contact Person Name&nbsp;<span style=""color: red;""><b>*</b></span></label>
                                        <input type=""text"" class=""form-control""");
            BeginWriteAttribute("id", " id=\"", 3064, "\"", 3069, 0);
            EndWriteAttribute();
            WriteLiteral(@" autocomplete=""off"" placeholder=""Contact Person Name""/>
                                    </div>
                                </div>
                            </div>
                            <div class=""row"">
            ...
            WriteLiteral(@"control"" id=""email"" autocomplete=""off"" placeholder=""Email"" required />
                                    </div>
                                </div>
                            </div>
                            <div class=""row"">
                                 <div class=""col-lg-6"">
                                    <div class=""form-group"">
                                        <label class=""control-label"">GSTIN No&nbsp;<span style=""color: red;""><b>*</b></span></label>
                                        <input type=""text"" class=""form-control""");
            BeginWriteAttribute("id", " id=\"", 4665, "\"", 4670, 0);
            EndWriteAttribute();
            WriteLiteral(@" autocomplete=""off"" placeholder=""GSTIN No""/>
                                    </div>
                                </div>
                                <div class=""col-lg-6"">
                                    <div class=""form-group"">
            ...
            WriteLiteral(@"autocomplete=""off"" placeholder=""User name"" required />
                                    </div>
                                </div>
                                <div class=""col-lg-6"">
                                    <div class=""form-group"">
                            ...
                            <div class=""row"">
                                <div class=""col-lg-6"">
                                    <div class=""form-group"">
                                        <label class=""control-label"">Contact Person DOB</label>
            ...
            WriteLiteral(@"                   <div class=""input-group-prepend"">
                                ...
                                <div class=""col-lg-6"">
                                    <div class=""form-group"">
                                        <label class=""control-label"">Company Logo&nbsp;<span style=""color: red;""><b>*</b></span></label>
                                        <div class=""custom-file mt-0"">
                                            <input type=""file"" class=""custom-file-input"" id=""pp"" name=""pp"" required>
                                            <label class=""custom-file-label"" for=""proPic"">Choo");
            WriteLiteral(@"se file</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class=""col-lg-2"">
                                    <div class=""text-center"">
                                        <img id=""profilePic""");
            BeginWriteAttribute("src", " src=\"", 8073, "\"", 8079, 0);
            EndWriteAttribute();
            ...
            $('#userTable tbody').on('click', 'button[data-target=""#delete""]', function () {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        url: """);
#nullable restore
#line 209 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                         Write(apiUrl);
...
#nullable restore
#line 212 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
...
#nullable disable
            ...
            $(""#btnSave"").click(function (e) {
                ...
                WriteLiteral(@"   email: $.trim($(""#email"").val()),
                        ...
                        addedBy: ");
#nullable restore
#line 260 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
...
#nullable disable
                WriteLiteral(",\r\n                    }\r\n                    //console.log(model);\r\n                    $.ajax({\r\n                        type: \"POST\",\r\n                        url: \"");
#nullable restore
#line 265 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                         Write(apiUrl);
...
#nullable restore
#line 269 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                                                Write(Context.Session.GetString("TokenTxt"));
            ...
            ");
                WriteLiteral(@"        imgPath = '';
                    ...
                    var model = {
                        ...
                        userName: $.trim($(""#username"").val()),
                        password");
                WriteLiteral(": $.trim($(\"#password\").val()),\r\n                        hospitalMasterid: parseInt($(\"#hopital\").val()),\r\n                        lastUpdatedBy: ");
#nullable restore
#line 328 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                                  Write(Context.Session.GetInt32("UserId"));
...
#nullable disable
                WriteLiteral(",\r\n                    }\r\n                    //console.log(model);\r\n                    $.ajax({\r\n                        type: \"POST\",\r\n                        url: \"");
#nullable restore
#line 333 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                         Write(apiUrl);
...
#nullable restore
#line 337 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                                                Write(Context.Session.GetString("TokenTxt"));
...
#nullable disable
        ...
        function loadSingleUser(id) {
            $.ajax({
                ...
                url: """);
#nullable restore
#line 373 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                 Write(apiUrl);
...
#nullable restore
#line 376 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                                        Write(Context.Session.GetString("TokenTxt"));
        ...
        function loadUsers() {
            ...
            table = $('#userTable').dataTable({
                ...
                ""ajax"": {
                    ""url"": '");
#nullable restore
#line 422 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                       Write(apiUrl);
...
#nullable restore
#line 426 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                                            Write(Context.Session.GetString("TokenTxt"));
...
#nullable restore
#line 476 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                 Write(apiUrl);
...
#nullable restore
#line 479 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                                        Write(Context.Session.GetString("TokenTxt"));
...
#nullable disable
                ...
                WriteLiteral(@"se if (data.status == 403) {
                        window.location.replace('/Message/Unauthorize');
                    }
                }
            });
        ...
        function GetHospitalName(id) {
            ...
            $.ajax({
                ...
                url: """);
#nullable restore
#line 512 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                 Write(apiUrl);
...
#nullable restore
#line 515 "E:\Pravat Project\EOrderBook\AdminClient\Views\User\UserList.cshtml"
                                        Write(Context.Session.GetString("TokenTxt"));
