...
namespace AdminClient
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IMobileUpload, MobileUploadProvider>();
            services.AddScoped<IHttpWebClients, HttpWebClients>();
            services.AddScoped<ICreditHistory, CreditHistoryProvider>();
            services.AddScoped<IHttpWebClients, HttpWebClients>();
            services.AddScoped<IStoreNotification, StoreNotificationProvider>();
        }
